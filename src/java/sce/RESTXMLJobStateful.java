 ...
 */
public class RESTXMLJobStateful implements InterruptableJob {

    private URLConnection urlConnection;

    public RESTXMLJobStateful() {
    }
    ...
    public static String parseXMLResponse(Node node, String binding, JobExecutionContext context) throws JobExecutionException {
        ...
        try {
            ...
            if (node.getNodeName().equals("literal") && parentNodeName.equals("binding") && parentNodeAttribute != null && bindingValue.equalsIgnoreCase(binding) && parentParentNodeName.equals("result")) {
